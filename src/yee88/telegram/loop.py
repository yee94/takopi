...
def _same_topic_project(left: RunContext | None, right: RunContext | None) -> bool:
    if left is None or right is None:
        return True
    if left.project is None or right.project is None:
        return True
    ...
    async def resolve(
        ...
        *,
        ...
        if (
            ...
            if (
                thread is not None
                and _same_topic_project(thread.context, context)
            ):
